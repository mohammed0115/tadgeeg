...
PACKAGE_POLICY = {
    PlanCode.FREE_TRIAL: {"retention_months": 3, "backup_frequency": "none", "feature_tiers": {"reports": "basic", "dashboard": "none", "fraud_detection": "basic", "permissions": "basic", "audit_log": "none", "approvals": "none", "report_customization": "none", "whatsapp": False, "api": "none", "erp": "none", "white_label": "none"}},
    PlanCode.STARTER: {"retention_months": 3, "backup_frequency": "weekly", "feature_tiers": {"reports": "basic", "dashboard": "none", "fraud_detection": "basic", "permissions": "basic", "audit_log": "none", "approvals": "none", "report_customization": "none", "whatsapp": False, "api": "none", "erp": "none", "white_label": "none"}},
    PlanCode.BASIC: {"retention_months": 12, "backup_frequency": "weekly", "feature_tiers": {"reports": "advanced", "dashboard": "basic", "fraud_detection": "advanced", "permissions": "advanced", "audit_log": "none", "approvals": "none", "report_customization": "limited", "whatsapp": False, "api": "none", "erp": "none", "white_label": "none"}},
    PlanCode.BUSINESS: {"retention_months": 24, "backup_frequency": "daily", "feature_tiers": {"reports": "professional", "dashboard": "advanced", "fraud_detection": "professional", "permissions": "advanced", "audit_log": "none", "approvals": "none", "report_customization": "basic", "whatsapp": False, "api": "limited", "erp": "optional", "white_label": "none"}},
    PlanCode.PROFESSIONAL: {"retention_months": 36, "backup_frequency": "daily", "feature_tiers": {"reports": "professional", "dashboard": "interactive", "fraud_detection": "professional", "permissions": "full", "audit_log": "full", "approvals": "none", "report_customization": "advanced", "whatsapp": True, "api": "full", "erp": "optional", "white_label": "optional"}},
    PlanCode.ENTERPRISE: {"retention_months": 60, "backup_frequency": "hourly", "feature_tiers": {"reports": "custom", "dashboard": "custom", "fraud_detection": "custom", "permissions": "unlimited", "audit_log": "full", "approvals": "multi", "report_customization": "full", "whatsapp": True, "api": "full", "erp": "full", "white_label": "full"}},
