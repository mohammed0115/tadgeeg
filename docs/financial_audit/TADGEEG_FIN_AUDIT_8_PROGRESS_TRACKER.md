...
- **9D** المخزون (ISA 501) / الأصول الثابتة / الرواتب — آخر فجوة كبرى.
- المؤجّل: واجهات **ISA 300/330/240** (list-builders).
- تحسينات: PDF لخطاب الإدارة · ربط ردود التأكيدات بأدلة 6A · إرسال بريد.
