...
DOC_RULES: dict[str, tuple[str, str]] = {
    ...
    "BNK-010": ("تسلسل الرصيد الجاري سليم لكل معاملة",                 "critical"),
    "BNK-011": ("معاملات ≥ 100,000 ر.س موثَّقة (AML)",                  "high"),
    "BNK-012": ("لا توجد معاملات في ساعات متأخرة غير مبررة",           "medium"),
    "BNK-013": ("رصيد الختام غير سالب (أو السحب موثَّق)",               "medium"),
    "BNK-014": ("وصف المعاملات متوفر (≥ 95%)",                          "medium"),
    "BNK-015": ("أرقام مرجعية للمعاملات (≥ 80%)",                       "medium"),
    "BNK-016": ("تنوّع الأطراف المقابلة (أكبر طرف ≤ 50%)",              "high"),
    "BNK-017": ("تغطية الفترة المعلنة كاملة (≥ 80%)",                   "medium"),
    ...
    "PAY-010": ("نسبة GOSI ضمن النطاق المنطقي (3%-22%)",                "high"),
    "PAY-011": ("لا يوجد صافي راتب سالب",                               "critical"),
    "PAY-012": ("الخصومات لا تتجاوز 50% من الراتب (المادة 92)",         "high"),
    "PAY-013": ("الحد الأدنى للأجور للسعوديين (4000 ر.س)",              "high"),
    "PAY-014": ("متطلبات حماية الأجور (WPS) مكتملة",                    "high"),
    "PAY-015": ("تاريخ الدفع خلال أسبوعين من نهاية الفترة",             "medium"),
    "PAY-016": ("لا توجد رواتب شاذة (> 5× الوسيط)",                     "medium"),
    "PAY-017": ("البدلات لا تتجاوز إجمالي الراتب",                      "medium"),
    ...
    "EXP-009": ("فصل المهام: المعتمِد ليس هو المُطالِب (ISA 240)",      "high"),
    "EXP-010": ("كل بند مصنّف ضمن فئة مصروفات",                         "medium"),
    "EXP-011": ("لا توجد مصروفات بتاريخ مستقبلي",                       "high"),
    "EXP-012": ("تقديم التقرير خلال 60 يوماً من نهاية الفترة",          "medium"),
    "EXP-013": ("المطالب = المعتمد + المرفوض",                          "high"),
    "EXP-014": ("وصف موجود لكل بند مصروف",                              "medium"),
    "EXP-015": ("لا توجد مصروفات في عطلة نهاية الأسبوع",                "medium"),
    "EXP-016": ("رقم الإيصال موجود لكل إيصال مرفق",                     "medium"),
    ...
    "VATR-009": ("إجمالي المبيعات = خاضعة + صفرية + معفاة",             "high"),
    "VATR-010": ("السداد يغطي صافي الضريبة المستحقة",                  "high"),
    "VATR-011": ("مرجع ZATCA موجود للإقرارات المُقدَّمة",               "high"),
    "VATR-012": ("تاريخ التقديم ليس في المستقبل",                       "high"),
    "VATR-013": ("مدة الفترة منطقية (شهرية أو ربع سنوية)",              "medium"),
    "VATR-014": ("ضريبة المخرجات ≤ 16% من المبيعات الخاضعة",            "high"),
    "VATR-015": ("التأخير في التقديم < 30 يوم (لتجنّب الغرامة)",        "high"),
    "VATR-016": ("ضريبة المدخلات ≤ 16% من المشتريات الخاضعة",           "high"),
